package com.jkl.SistemaBotica.unitMeasure.service;

import com.jkl.SistemaBotica.Utils;
import com.jkl.SistemaBotica.unitMeasure.entitie.UnitMeasure;
import com.jkl.SistemaBotica.unitMeasure.repository.UnitMeasureRepository;
...
public class UnitMeasureService {
    ...
    public boolean delete(Long id) {
        com.jkl.SistemaBotica.unitMeasure.entitie.UnitMeasure unitMeasureToDelete = unitMeasureRepository.findById(id).orElse(null);
